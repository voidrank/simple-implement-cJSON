...
void testParse(){
    ...
    */
    JSON *obj1 = ParseJSONFromFile("test_complex.json");
    PrintJSON(obj1);
    DeleteItemFromObject(obj1, "123");
    PrintJSON(GetItemInJSON(obj1,"/goose house") );
    PrintJSONToFile(GetItemInJSON(obj1,"/goose house"), "goose_house.json");
}
